...
class Ramo {
    ...
    private:
        list<FormulaMarcada*> listaFormulas;//lista de fórmulas que estão no ramo
    ...
    public:
        ...
        Ramo(Ramo *ramo, FormulaMarcada* formula); //cria um ramo a partir de outro e de uma fórmula que deve ser adicionada ao final da lista (parte direita da expansão de alguma fórmula da lista original)
