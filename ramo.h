...
class Ramo {
    ...
    private:
        ...
        list<FormulaOrdenada> listaFormulas;
        
        //fórmulas que já foram expandidas, mas que podem ser usadas para fechar o ramo
        list<FormulaOrdenada> expandidas;

        //adiciona uma fórmula na lista de fórmulas expandidas, evitando duplicatas
        bool adicionaExpandidas(FormulaOrdenada formula); 

        
        //remove da lista de candidatos usada em aplicar() aqueles que são invalidados pelo argumento passado 
        void encontrarLinBif(tiposEstrategia estrategiaAtual, list<FormulaOrdenada>* candidatos);
        void encontrarPeqGrd(tiposEstrategia estrategiaAtual, list<FormulaOrdenada>* candidatos);
        void encontrarOp(tiposEstrategia estrategiaAtual, list<FormulaOrdenada>* candidatos);
    ...
    public:
        ...
        Ramo(Ramo *ramo, FormulaOrdenada formula); 
        ...
        Ramo* aplicar(list<tiposEstrategia> lista, unsigned int* proxNumeroOrdem); 
